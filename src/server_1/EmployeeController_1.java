...
public class EmployeeController_1 extends UnicastRemoteObject implements InterfaceDB<Employee> {
    private Connection connection;
    public EmployeeController_1(Connection connection) throws RemoteException {
